...
// 1️⃣ Define the schema without `userId` and infer its type:
...
export const CommentForm = ({
  ...
  // 2️⃣ Use the aligned schema + type here:
  ...
  // 3️⃣ Submit handler uses the same inputs:
  const handleSubmit = (values: CommentFormInputs) => {
    create.mutate(values);
  };
